...
export const TASK_STG_WIRE_USDC = `stg:wire::usdc`
export const TASK_STG_WIRE_USDC_INITIALIZE_MINTER = `stg:wire::usdc:initialize-minters`
export const TASK_STG_WIRE_USDC_SET_ADMIN = `stg:wire::usdc:set-admin`
