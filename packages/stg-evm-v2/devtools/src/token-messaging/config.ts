...
const createAssetLogger = () => createModuleLogger('TokenMessaging')
const withAsyncLogger = createWithAsyncLogger(createAssetLogger)

export const configurePlanner: TokenMessagingConfigurator = withAsyncLogger(
    createConfigureNodes(
        withAsyncLogger(
            async ({ config }, sdk) => {
...
export const configureGasLimit: TokenMessagingConfigurator = withAsyncLogger(
    createConfigureEdges(
        withAsyncLogger(
