                ...
                config: {
                    ...
                    allocations: {
                        [ethRewardTokenAddresses.STG]: {
                            [lpTokenAddresses[EndpointId.ETHEREUM_V2_MAINNET].ETH]: 4267,
                            [lpTokenAddresses[EndpointId.ETHEREUM_V2_MAINNET].USDC]: 3600,
                            [lpTokenAddresses[EndpointId.ETHEREUM_V2_MAINNET].USDT]: 2133,
                        },
                    },
                },
            },
