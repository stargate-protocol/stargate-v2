...
module.exports = async function ({ deployments, getNamedAccounts }) {
    ...
    if (hre.network.name == "zksync-mainnet") {
        ...
        console.log("constructor args:" + oftWrapper.interface.encodeDeploy(constructorArgs))
        ...
        const contract = new ethers.Contract(MULTI_SIGS[hre.network.name], artifact.abi, signer)
