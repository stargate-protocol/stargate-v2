...
export interface BlacklistableMockInterface extends utils.Interface {
    functions: {
...
export interface BlacklistableMock extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: BlacklistableMockInterface
