...
export interface IStargateV1PoolInterface extends utils.Interface {
    functions: {
...
export interface IStargateV1Pool extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: IStargateV1PoolInterface
