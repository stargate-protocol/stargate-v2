...
export interface IStargateEthVaultInterface extends utils.Interface {
    functions: {
    ...
    getFunction(
        nameOrSignatureOrTopic: 'approve' | 'deposit' | 'transfer' | 'transferFrom' | 'withdraw'
    ): FunctionFragment
...
export interface IStargateEthVault extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: IStargateEthVaultInterface
