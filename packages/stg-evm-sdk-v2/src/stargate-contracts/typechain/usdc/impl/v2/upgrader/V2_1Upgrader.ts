...
export interface V2_1UpgraderInterface extends utils.Interface {
    functions: {
        'abortUpgrade()': FunctionFragment
        'helper()': FunctionFragment
        'implementation()': FunctionFragment
        'lostAndFound()': FunctionFragment
    ...
    encodeFunctionData(functionFragment: 'lostAndFound', values?: undefined): string
    ...
    decodeFunctionResult(functionFragment: 'lostAndFound', data: BytesLike): Result
...
export interface V2_1Upgrader extends BaseContract {
    ...
    functions: {
        ...
        lostAndFound(overrides?: CallOverrides): Promise<[string]>
    ...
    estimateGas: {
        ...
        lostAndFound(overrides?: CallOverrides): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        lostAndFound(overrides?: CallOverrides): Promise<PopulatedTransaction>
