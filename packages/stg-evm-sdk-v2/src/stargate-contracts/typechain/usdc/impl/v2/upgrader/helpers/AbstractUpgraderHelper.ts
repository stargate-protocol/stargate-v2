...
export interface AbstractUpgraderHelperInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: 'owner' | 'proxy' | 'tearDown' | 'transferOwnership'): FunctionFragment
