...
export interface V2_2UpgraderInterface extends utils.Interface {
    functions: {
        'abortUpgrade()': FunctionFragment
        'accountsToBlacklist()': FunctionFragment
    ...
    encodeFunctionData(functionFragment: 'accountsToBlacklist', values?: undefined): string
    ...
    decodeFunctionResult(functionFragment: 'accountsToBlacklist', data: BytesLike): Result
...
export interface V2_2Upgrader extends BaseContract {
    ...
    functions: {
        ...
        accountsToBlacklist(overrides?: CallOverrides): Promise<[string[]]>
    ...
    estimateGas: {
        ...
        accountsToBlacklist(overrides?: CallOverrides): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        accountsToBlacklist(overrides?: CallOverrides): Promise<PopulatedTransaction>
