...
export interface StargateOFTUSDCInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: 'transferTokenOwnership', values: [PromiseOrValue<string>]): string
...
export interface StargateOFTUSDC extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: StargateOFTUSDCInterface
    ...
    callStatic: {
        ...
        transferTokenOwnership(_newOwner: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>
