...
import type { StargateBase, StargateBaseInterface } from '../StargateBase'
...
export class StargateBase__factory {
    static readonly abi = _abi
    static createInterface(): StargateBaseInterface {
        return new utils.Interface(_abi) as StargateBaseInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): StargateBase {
        return new Contract(address, _abi, signerOrProvider) as StargateBase
    }
}
