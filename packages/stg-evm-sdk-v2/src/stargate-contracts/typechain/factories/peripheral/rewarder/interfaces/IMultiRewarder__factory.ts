...
import type { IMultiRewarder, IMultiRewarderInterface } from '../../../../peripheral/rewarder/interfaces/IMultiRewarder'
...
export class IMultiRewarder__factory {
    static readonly abi = _abi
    static createInterface(): IMultiRewarderInterface {
        return new utils.Interface(_abi) as IMultiRewarderInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): IMultiRewarder {
        return new Contract(address, _abi, signerOrProvider) as IMultiRewarder
    }
}
