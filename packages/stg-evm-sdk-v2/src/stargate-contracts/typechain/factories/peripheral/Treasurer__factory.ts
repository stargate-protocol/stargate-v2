...
import type { Treasurer, TreasurerInterface } from '../../peripheral/Treasurer'
...
type TreasurerConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: TreasurerConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
    xs.length > 1

export class Treasurer__factory extends ContractFactory {
    constructor(...args: TreasurerConstructorParams) {
        if (isSuperArgs(args)) {
            super(...args)
        } else {
    ...
    override deploy(
        ...
        return super.deploy(_owner, _admin, overrides || {}) as Promise<Treasurer>
    }
    override getDeployTransaction(
        ...
        return super.getDeployTransaction(_owner, _admin, overrides || {})
    }
    override attach(address: string): Treasurer {
        return super.attach(address) as Treasurer
    }
    override connect(signer: Signer): Treasurer__factory {
        return super.connect(signer) as Treasurer__factory
    }

    static readonly bytecode = _bytecode
    static readonly abi = _abi
    static createInterface(): TreasurerInterface {
        return new utils.Interface(_abi) as TreasurerInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): Treasurer {
        return new Contract(address, _abi, signerOrProvider) as Treasurer
    }
}
