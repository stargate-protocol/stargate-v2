...
import type { FiatTokenProxy, FiatTokenProxyInterface } from '../../../../usdc/impl/v1/FiatTokenProxy'
...
type FiatTokenProxyConstructorParams = [signer?: Signer] | ConstructorParameters<typeof ContractFactory>

const isSuperArgs = (xs: FiatTokenProxyConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
    xs.length > 1
...
export class FiatTokenProxy__factory extends ContractFactory {
    ...
    ): Promise<FiatTokenProxy> {
        return super.deploy(implementationContract, overrides || {}) as Promise<FiatTokenProxy>
    }
    ...
    override attach(address: string): FiatTokenProxy {
        return super.attach(address) as FiatTokenProxy
    }
    override connect(signer: Signer): FiatTokenProxy__factory {
        return super.connect(signer) as FiatTokenProxy__factory
    }

    static readonly bytecode = _bytecode
    static readonly abi = _abi
    static createInterface(): FiatTokenProxyInterface {
        return new utils.Interface(_abi) as FiatTokenProxyInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): FiatTokenProxy {
        return new Contract(address, _abi, signerOrProvider) as FiatTokenProxy
    }
}
