...
export interface OFTTokenERC20UpgradeableInterface extends utils.Interface {
    functions: {
...
export interface OFTTokenERC20Upgradeable extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: OFTTokenERC20UpgradeableInterface
