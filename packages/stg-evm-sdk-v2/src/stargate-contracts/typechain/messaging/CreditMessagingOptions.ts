...
export interface CreditMessagingOptionsInterface extends utils.Interface {
    functions: {
...
export interface CreditMessagingOptions extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: CreditMessagingOptionsInterface
