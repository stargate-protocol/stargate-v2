...
export declare namespace LzReadCounter {
    export type EvmReadRequestStruct = {
        ...
        countAddition: PromiseOrValue<BigNumberish>
    }

    export type EvmReadRequestStructOutput = [number, number, boolean, BigNumber, number, string, BigNumber] & {
        ...
        to: string
        countAddition: BigNumber
    }

    export type ComputeSettingStruct = {
        computeSetting: PromiseOrValue<BigNumberish>
        computeConfirmations: PromiseOrValue<BigNumberish>
        blockNumOrTimestamp: PromiseOrValue<BigNumberish>
        isBlockNum: PromiseOrValue<boolean>
    }

    export type ComputeSettingStructOutput = [number, number, BigNumber, boolean] & {
        computeSetting: number
        computeConfirmations: number
        blockNumOrTimestamp: BigNumber
        isBlockNum: boolean
    }
}

export interface LzReadCounterInterface extends utils.Interface {
    functions: {
        'allowInitializePath((uint32,bytes32,uint64))': FunctionFragment
        'buildCmd(uint16,(uint16,uint32,bool,uint64,uint16,address,uint256)[],(uint8,uint16,uint64,bool))': FunctionFragment
        'clearCount()': FunctionFragment
        ...
        'quote(uint32,uint16,(uint16,uint32,bool,uint64,uint16,address,uint256)[],(uint8,uint16,uint64,bool),bytes)': FunctionFragment
        'readCount(uint256)': FunctionFragment
        ...
        'triggerRead(uint32,uint16,(uint16,uint32,bool,uint64,uint16,address,uint256)[],(uint8,uint16,uint64,bool),bytes)': FunctionFragment
    }
    ...
    encodeFunctionData(
        ...
        values: [PromiseOrValue<BigNumberish>, LzReadCounter.EvmReadRequestStruct[], LzReadCounter.ComputeSettingStruct]
    ): string
    encodeFunctionData(functionFragment: 'clearCount', values?: undefined): string
    ...
    encodeFunctionData(
        ...
        values: [
            ...
            PromiseOrValue<BigNumberish>,
            LzReadCounter.EvmReadRequestStruct[],
            LzReadCounter.ComputeSettingStruct,
            PromiseOrValue<BytesLike>,
        ]
    ): string
    encodeFunctionData(functionFragment: 'readCount', values: [PromiseOrValue<BigNumberish>]): string
    ...
    decodeFunctionResult(functionFragment: 'clearCount', data: BytesLike): Result
    ...
    decodeFunctionResult(functionFragment: 'readCount', data: BytesLike): Result
    ...
    decodeFunctionResult(functionFragment: 'triggerRead', data: BytesLike): Result
...
export interface LzReadCounter extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: LzReadCounterInterface
    ...
    functions: {
        ...
        buildCmd(
            appLabel: PromiseOrValue<BigNumberish>,
            _readRequests: LzReadCounter.EvmReadRequestStruct[],
            _computeSetting: LzReadCounter.ComputeSettingStruct,
            overrides?: CallOverrides
        ): Promise<[string]>

        clearCount(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<ContractTransaction>
        ...
        quote(
            ...
            _appLabel: PromiseOrValue<BigNumberish>,
            _requests: LzReadCounter.EvmReadRequestStruct[],
            _computeSetting: LzReadCounter.ComputeSettingStruct,
            _options: PromiseOrValue<BytesLike>,
            overrides?: CallOverrides
        ): Promise<[BigNumber, BigNumber] & { nativeFee: BigNumber; lzTokenFee: BigNumber }>

        readCount(countAddition: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>
    ...
    callStatic: {
        ...
        clearCount(overrides?: CallOverrides): Promise<void>
    ...
    estimateGas: {
        ...
        clearCount(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<BigNumber>
    ...
    populateTransaction: {
        ...
        clearCount(overrides?: Overrides & { from?: PromiseOrValue<string> }): Promise<PopulatedTransaction>
        ...
        readCount(countAddition: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>
