...
import type { SimpleMessageLib, SimpleMessageLibInterface } from '../../messagelib/SimpleMessageLib'
...
const isSuperArgs = (xs: SimpleMessageLibConstructorParams): xs is ConstructorParameters<typeof ContractFactory> =>
    xs.length > 1

export class SimpleMessageLib__factory extends ContractFactory {
    ...
    override deploy(
        ...
        return super.deploy(_endpoint, _treasury, overrides || {}) as Promise<SimpleMessageLib>
    }
    ...
    override attach(address: string): SimpleMessageLib {
        return super.attach(address) as SimpleMessageLib
    }
    override connect(signer: Signer): SimpleMessageLib__factory {
        return super.connect(signer) as SimpleMessageLib__factory
    }

    static readonly bytecode = _bytecode
    static readonly abi = _abi
    static createInterface(): SimpleMessageLibInterface {
        return new utils.Interface(_abi) as SimpleMessageLibInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): SimpleMessageLib {
        return new Contract(address, _abi, signerOrProvider) as SimpleMessageLib
    }
}
