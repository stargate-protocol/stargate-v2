...
import type { PreCrimeE1, PreCrimeE1Interface } from '../../../precrime/extensions/PreCrimeE1'
...
export class PreCrimeE1__factory {
    static readonly abi = _abi
    static createInterface(): PreCrimeE1Interface {
        return new utils.Interface(_abi) as PreCrimeE1Interface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): PreCrimeE1 {
        return new Contract(address, _abi, signerOrProvider) as PreCrimeE1
    }
}
