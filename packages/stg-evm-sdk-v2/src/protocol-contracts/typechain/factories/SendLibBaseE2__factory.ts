...
import type { SendLibBaseE2, SendLibBaseE2Interface } from '../SendLibBaseE2'
...
export class SendLibBaseE2__factory {
    static readonly abi = _abi
    static createInterface(): SendLibBaseE2Interface {
        return new utils.Interface(_abi) as SendLibBaseE2Interface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): SendLibBaseE2 {
        return new Contract(address, _abi, signerOrProvider) as SendLibBaseE2
    }
}
