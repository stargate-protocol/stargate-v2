...
import type { SendLibBase, SendLibBaseInterface } from '../SendLibBase'
...
export class SendLibBase__factory {
    ...
    static createInterface(): SendLibBaseInterface {
        return new utils.Interface(_abi) as SendLibBaseInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): SendLibBase {
        return new Contract(address, _abi, signerOrProvider) as SendLibBase
    }
}
