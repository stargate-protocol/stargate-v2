...
import type { UlnBase, UlnBaseInterface } from '../../uln/UlnBase'
...
export class UlnBase__factory {
    static readonly abi = _abi
    static createInterface(): UlnBaseInterface {
        return new utils.Interface(_abi) as UlnBaseInterface
    }
    static connect(address: string, signerOrProvider: Signer | Provider): UlnBase {
        return new Contract(address, _abi, signerOrProvider) as UlnBase
    }
}
