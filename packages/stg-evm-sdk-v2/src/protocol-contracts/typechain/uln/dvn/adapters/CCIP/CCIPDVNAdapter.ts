...
export interface CCIPDVNAdapterInterface extends utils.Interface {
    functions: {
    ...
    encodeFunctionData(functionFragment: 'setDstConfig', values: [ICCIPDVNAdapter.DstConfigParamStruct[]]): string
...
export interface CCIPDVNAdapter extends BaseContract {
    ...
    functions: {
        ...
        ccipReceive(
            _message: Client.Any2EVMMessageStruct,
        ...
        setDstConfig(
            _params: ICCIPDVNAdapter.DstConfigParamStruct[],
            overrides?: Overrides & { from?: PromiseOrValue<string> }
        ): Promise<ContractTransaction>
        ...
        srcConfig(
            srcChainSelector: PromiseOrValue<BigNumberish>,
            overrides?: CallOverrides
    ...
    callStatic: {
        ...
        ccipReceive(_message: Client.Any2EVMMessageStruct, overrides?: CallOverrides): Promise<void>
        ...
        setDstConfig(_params: ICCIPDVNAdapter.DstConfigParamStruct[], overrides?: CallOverrides): Promise<void>
