...
export interface ArbitrumDVNAdapterL2Interface extends utils.Interface {
    functions: {
...
export type PeerSetEvent = TypedEvent<[string], PeerSetEventObject>
...
export interface ArbitrumDVNAdapterL2 extends BaseContract {
    ...
    filters: {
        ...
        'PeerSet(address)'(peer?: null): PeerSetEventFilter
        PeerSet(peer?: null): PeerSetEventFilter
