...
export interface OptimismDVNAdapterL1Interface extends utils.Interface {
    functions: {
...
export type GasLimitSetEvent = TypedEvent<[number], GasLimitSetEventObject>
...
export interface OptimismDVNAdapterL1 extends BaseContract {
