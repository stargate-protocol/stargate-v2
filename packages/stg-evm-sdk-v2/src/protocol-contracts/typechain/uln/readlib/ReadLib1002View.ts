...
export interface ReadLib1002ViewInterface extends utils.Interface {
    functions: {
        ...
        'getVerifiablePayloadHash(address,uint32,bytes32,bytes32)': FunctionFragment
    ...
    encodeFunctionData(
        functionFragment: 'getVerifiablePayloadHash',
        values: [
    ...
    decodeFunctionResult(functionFragment: 'getVerifiablePayloadHash', data: BytesLike): Result
...
export interface ReadLib1002View extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this
    attach(addressOrName: string): this
    deployed(): Promise<this>

    interface: ReadLib1002ViewInterface
