...
export interface MessagingComposerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(
        nameOrSignatureOrTopic: 'composeQueue' | 'lzCompose' | 'lzComposeAlert' | 'sendCompose'
    ): FunctionFragment
...
export interface MessagingComposer extends BaseContract {
