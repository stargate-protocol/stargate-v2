...
export interface OFTAdapterInterface extends utils.Interface {
    functions: {
...
export type MsgInspectorSetEvent = TypedEvent<[string], MsgInspectorSetEventObject>
...
export interface OFTAdapter extends BaseContract {
    ...
    functions: {
        ...
        quoteSend(
            ...
            overrides?: CallOverrides
        ): Promise<[MessagingFeeStructOutput] & { msgFee: MessagingFeeStructOutput }>
