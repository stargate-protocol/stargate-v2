...
export const NETWORKS: NetworksConfig = {
    ...
    [EndpointId.SOMNIA_V2_MAINNET]: {
        ...
        tokenMessaging: {
            ...
            executor: EXECUTORS.LZ_LABS[EndpointId.SOMNIA_V2_MAINNET],
            nativeDropAmount: parseEther('0.01').toBigInt(),
            taxiGasLimit: 1_000_000n + 20n * DEFAULT_TOKEN_MESSAGING_NETWORK_CONFIG.taxiGasLimit,
            busGasLimit: 1_000_000n + 20n * DEFAULT_TOKEN_MESSAGING_NETWORK_CONFIG.busGasLimit,
            busRideGasLimit: 1_000_000n + 20n * DEFAULT_TOKEN_MESSAGING_NETWORK_CONFIG.busRideGasLimit,
            nativeDropGasLimit: 1_000_000n + 20n * DEFAULT_TOKEN_MESSAGING_NETWORK_CONFIG.nativeDropGasLimit,
        },
        safeConfig: {
