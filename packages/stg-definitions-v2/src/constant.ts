...
export const DVNS = {
    ...
    CANARY: {
        [EndpointId.ABSTRACT_V2_MAINNET]: '0xcb773caf620d2a6703d2cd30c567a6c2906ccfbb',
        [EndpointId.APE_V2_MAINNET]: '0x9bb011796fc3604d3a4faa5863f587a33f6224af',
        [EndpointId.APEXFUSIONNEXUS_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.ARBITRUM_V2_MAINNET]: '0xf2e380c90e6c09721297526dbc74f870e114dfcb',
        [EndpointId.AULT_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        ...
        [EndpointId.CAMP_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        ...
        [EndpointId.DOMA_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        ...
        [EndpointId.GATELAYER_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.GENSYN_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.GLUE_V2_MAINNET]: '0xe4e65d80deb0e2c8391215bcba4b5f7603420407',
        ...
        [EndpointId.HEMI_V2_MAINNET]: '0x396dc0a78f789586e2982fccd830c5954c193f3c',
        [EndpointId.HORIZEN_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.INJECTIVEEVM_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.INK_V2_MAINNET]: '0x1e4ce74ccf5498b19900649d9196e64bab592451',
        [EndpointId.IOTA_V2_MAINNET]: '0xecbaa45c33ce6fa284995e5f8314f5bc7f1c2008',
        ...
        [EndpointId.MOCA_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.NIBIRU_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.OG_V2_MAINNET]: '0x183940c4855a01da92bc2f96f7e0a8aecbf797ff',
        [EndpointId.OPTIMISM_V2_MAINNET]: '0x5b6735c66d97479ccd18294fc96b3084ecb2fa3f',
        [EndpointId.ORDERLY_V2_MAINNET]: '0xd42306df1a805d8053bc652ce0cd9f62bde80146',
        [EndpointId.PEAQ_V2_MAINNET]: '0x0c0c8fd5351fd936a987c790d88b137df4e73d64',
        ...
        [EndpointId.RARIBLE_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        [EndpointId.REDBELLY_V2_MAINNET]: '0x0000000000000000000000000000000000000000', // TODO: needs to be deployed
        ...
        [EndpointId.SWELL_V2_MAINNET]: '0xa2447e5b58d357c49bf74b50b14421e6a100e525',
        ...
        [EndpointId.XDC_V2_MAINNET]: '0x307d81ef09c72730f57667bf1e9b62db4904053f',
        [EndpointId.ZKCONSENSYS_V2_MAINNET]: '0xda63525a0fc42bcc2cad1dd28708d5ed11849347',
    } satisfies Partial<Record<EndpointId, string>>,
}
...
export const NETWORKS: NetworksConfig = {
    ...
    [EndpointId.GLUE_V2_MAINNET]: {
        creditMessaging: {
            ...
            requiredDVNs: [
                ...
                DVNS.CANARY[EndpointId.GLUE_V2_MAINNET],
            ],
    ...
    [EndpointId.STABLE_V2_MAINNET]: {
        creditMessaging: {
            ...DEFAULT_CREDIT_MESSAGING_NETWORK_CONFIG,
            requiredDVNs: [
                DVNS.NETHERMIND[EndpointId.STABLE_V2_MAINNET],
    ...
    [EndpointId.SWELL_V2_MAINNET]: {
        creditMessaging: {
            ...
            requiredDVNs: [
                ...
                DVNS.CANARY[EndpointId.SWELL_V2_MAINNET],
            ],
    ...
    [EndpointId.TEMPO_V2_MAINNET]: {
        creditMessaging: {
            ...DEFAULT_CREDIT_MESSAGING_NETWORK_CONFIG,
            requiredDVNs: [
                DVNS.NETHERMIND[EndpointId.TEMPO_V2_MAINNET],
                DVNS.LZ_LABS[EndpointId.TEMPO_V2_MAINNET],
