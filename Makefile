...
configure-testnet:
	...
	# Transfer ownership
	$(TRANSFER_OWNERSHIP) $(CONFIGURE_ARGS_COMMON) --oapp-config $(CONFIG_BASE_PATH)/usdc-token.config.ts --signer usdcAdmin # TODO change this to deployer when actually configuring testnet
