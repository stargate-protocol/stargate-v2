...
You are helping configure and deploy a new chain for Stargate V2. The flow is: 0. Create a branch `deployments/<chain-name>`
...
Use `oneSigConfig` only. Do not add `safeConfig` for new chains.
